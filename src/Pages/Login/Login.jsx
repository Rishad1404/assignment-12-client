                            ...
                            <form onSubmit={handleLogin}>
                                ...
                                <div className="mt-4">
                                    <div className="space-y-1">
                                        <label htmlFor="password" className="block mb-2 text-sm font-medium  dark:text-gray-600">
                                            Password
                                        </label>
                                        <div className="dark:text-gray-600 relative">
                                            <input
                                                ...
                                                className="block w-full px-4 py-4 text-gray-700 bg-white border rounded-lg dark:text-gray-300 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300"
                                                required
                                            />
                                        </div>
                                    </div>
